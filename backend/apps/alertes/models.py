...
class Alerte(models.Model):
    ...
    prix_min = models.IntegerField(null=True, blank=True)
    prix_max = models.IntegerField(null=True, blank=True)
    km_max = models.IntegerField(null=True, blank=True)
    annee_min = models.IntegerField(null=True, blank=True)
    carburant = models.CharField(max_length=20, blank=True)
    boite_vitesse = models.CharField(max_length=20, blank=True)
