<<<<<<< C:/Users/PC DZ/Desktop/AUTO-P/frontend/src/components/ui/Header.jsx
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-primary-elevated border border-primary-border/DEFAULT rounded-lg shadow-2xl shadow-card animate-fade-in">
                    <div className="p-2">
                      ...
                      <a href="#parametres" className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-primary-card transition-colors duration-200">
                        ...
                        <span className="text-primary-text-primary">Paramètres</span>
                      </a>
            ...
            <div className="p-4">
              ...
              <nav className="space-y-2">
                ...
                <a href="#marche" className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-primary-card transition-colors duration-200">
                  <TrendingUp className="w-4 h-4" />
                  <span className="text-primary-text-primary">Marché</span>
                </a>
...
<<<<<<< C:/Users/PC DZ/Desktop/AUTO-P/frontend/src/components/ui/Header.jsx
<<<<<<< C:/Users/PC DZ/Desktop/AUTO-P/frontend/src/components/ui/Header.jsx
                      <button className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-primary-card transition-colors duration-200 w-full text-left">
                        <LogOut className="w-4 h-4" />
                        <span className="text-primary-text-primary">Déconnexion</span>
                      </button>
=======
=======
>>>>>>> C:/Users/PC DZ/.windsurf/worktrees/AUTO-P/AUTO-P-47e4966c/frontend/src/components/ui/Header.jsx
...
>>>>>>> C:/Users/PC DZ/.windsurf/worktrees/AUTO-P/AUTO-P-75a4c037/frontend/src/components/ui/Header.jsx
